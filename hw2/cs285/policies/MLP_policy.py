...
class MLPPolicyPG(MLPPolicy):
    ...
    def update(self, observations, actions, advantages, q_values=None):
        ...
        # DONE TODO: update the policy using policy gradient
        ...
        likelihoods=action_dists.log_prob(actions)
        weighted_likelihoods=likelihoods*advantages
        loss=torch.neg(torch.mean(weighted_likelihoods))
        self.optimizer.zero_grad()
        loss.backward()
        self.optimizer.step()

        if self.nn_baseline:
            ## DONE TODO: update the neural network baseline using the q_values as
            ...
            assert baselines.shape == targets.shape
            bl_loss=F.mse_loss(baselines,targets)
